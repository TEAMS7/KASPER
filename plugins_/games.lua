...
if KASPERBOT:get(KASPER_ID.."chencher"..msg.sender_user_id_) then 
if KASPERBOT:get(KASPER_ID.."chencher"..msg.sender_user_id_) ~= data.first_name_ then 
tahan = '['..(KASPERBOT:get(KASPER_ID.."chencher"..msg.sender_user_id_) or '')..']'
...
KASPERBOT:set(KASPER_ID.."chencher"..msg.sender_user_id_, data.first_name_) 
end,nil) 
end
if text == (KASPERBOT:get(KASPER_ID..':Set_Hzorh:'..msg.chat_id_) or '&57788') then -- // حزوره
KASPERBOT:incrby(KASPER_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
KASPERBOT:del(KASPER_ID..':Set_Hzorh:'..msg.chat_id_)
t = '*  🎁  احسنت اجابتك صحيحه   \n*   \n'
KASPER_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md')
end

if text == (KASPERBOT:get(KASPER_ID..':Set_Amthlh:'..msg.chat_id_) or '*678988') then -- // امثله
KASPERBOT:incrby(KASPER_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
KASPERBOT:del(KASPER_ID..':Set_Amthlh:'..msg.chat_id_)
t = '*  🎁  احسنت اجابتك صحيحه   \n*   \n'
KASPER_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md')
end

if text == (KASPERBOT:get(KASPER_ID..':Set_alii:'..msg.chat_id_) or '*67888') then -- // المختلف
KASPERBOT:incrby(KASPER_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
KASPERBOT:del(KASPER_ID..':Set_alii:'..msg.chat_id_)
t= '*  🎁  احسنت اجابتك صحيحه   \n*   \n'
KASPER_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md')
end 

if (text == (KASPERBOT:get(KASPER_ID.."GAME:CHER"..msg.chat_id_) or '&6-88')) then  
t = ' ⁞🚦 ⁞ اجابتك صحيحه ذكي وربي 😙'
KASPER_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md')
KASPERBOT:incrby(KASPER_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
KASPERBOT:del(KASPER_ID.."GAME:S"..msg.chat_id_)
KASPERBOT:del(KASPER_ID.."GAME:CHER"..msg.chat_id_)
...
if KASPERBOT:get(KASPER_ID.."GAME:S"..msg.chat_id_) then  
...
if text == ''..(KASPERBOT:get(KASPER_ID..'SMALE:GAME'..msg.chat_id_) or '')..'' and not KASPERBOT:get(KASPER_ID..'SMALE:GAMES'..msg.chat_id_) then
KASPERBOT:incrby(KASPER_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
KASPERBOT:set(KASPER_ID..'SMALE:GAMES'..msg.chat_id_,true)
NUMPGAME = (KASPERBOT:get(KASPER_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_))
KASPER_sendMsg(msg.chat_id_, msg.id_, 1,'*🎊 ⁞ مبروك فزت 🍂\n🎁 ⁞ اصبح عدد نقودك » { '..NUMPGAME..' }\n🎭 ⁞* للعب مره اخرى ارسل `الاسرع` \n', 1, 'md')
end 

if text == ''..(KASPERBOT:get(KASPER_ID..'CHEK:CHER'..msg.chat_id_) or '')..'' and not KASPERBOT:get(KASPER_ID..'RTEP:CHER'..msg.chat_id_) then
KASPERBOT:incrby(KASPER_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
KASPERBOT:set(KASPER_ID..'RTEP:CHER'..msg.chat_id_,true)
NUMPGAME = (KASPERBOT:get(KASPER_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_))
KASPER_sendMsg(msg.chat_id_, msg.id_, 1,'*🎊 ⁞ مبروك فزت 🍂\n🎁 ⁞ اصبح عدد نقودك » { '..NUMPGAME..' }\n🎭 ⁞* للعب مره اخرى ارسل `معاني` \n', 1, 'md')
end 

if text == ''..(KASPERBOT:get(KASPER_ID..'klmo'..msg.chat_id_) or 'لفاتع')..'' and not KASPERBOT:get(KASPER_ID..'CHER:GAME'..msg.chat_id_) then
KASPERBOT:incrby(KASPER_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
KASPERBOT:set(KASPER_ID..'CHER:GAME'..msg.chat_id_,true)
NUMPGAME = (KASPERBOT:get(KASPER_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_) or 0)
KASPER_sendMsg(msg.chat_id_, msg.id_, 1,'*🎊 ⁞ مبروك فزت 🍂\n🎁 ⁞ اصبح عدد نقودك » { '..NUMPGAME..' }\n🎭 ⁞* للعب مره اخرى ارسل `ترتيب` \n', 1, 'md')
end 

if KASPERBOT:get(KASPER_ID.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_) then 
...
KASPERBOT:del(KASPER_ID.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_)  
return false  end 
local GET_IDUSER = KASPERBOT:get(KASPER_ID..'SET:ID:USER'..msg.chat_id_)  
taha = "\n📬* ⁞ روح خالي 😉 تم اضافة له { "..text:match("^(%d+)$").." }* رساله"
KASPER_sendMsg(msg.chat_id_, msg.id_, 1,taha, 1, 'md') 
KASPERBOT:incrby(KASPER_ID..'user:messages:'..msg.chat_id_..':'..GET_IDUSER,text:match("^(%d+)$"))  

end
KASPERBOT:del(KASPER_ID.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_)  
end

if KASPERBOT:get(KASPER_ID.."SETEX:NUM"..msg.chat_id_..""..msg.sender_user_id_) then 
if text and text:match("^(%d+)$") then
if tonumber(text:match("^(%d+)$")) > 50000 then
taha = "*📬 ⁞ لا تستطيع اضافة اكثر من 1000 نقطه\n*"
KASPER_sendMsg(msg.chat_id_, msg.id_, 1,taha, 1, 'md') 
KASPERBOT:del(KASPER_ID.."SETEX:NUM"..msg.chat_id_..""..msg.sender_user_id_)  
return false  end 
local GET_IDUSER = KASPERBOT:get(KASPER_ID..'SET:ID:USER:NUM'..msg.chat_id_)  
taha = "\n📬* ⁞ طكو طكو عمي 😻 تم اضافة له { "..text:match("^(%d+)$").." }* نقطه"
KASPER_sendMsg(msg.chat_id_, msg.id_, 1,taha, 1, 'md') 
KASPERBOT:incrby(KASPER_ID..'NUM:GAMES'..msg.chat_id_..GET_IDUSER, text:match("^(%d+)$"))  
end
KASPERBOT:del(KASPER_ID.."SETEX:NUM"..msg.chat_id_..""..msg.sender_user_id_)  
end


if KASPERBOT:get(KASPER_ID.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 6 then
KASPER_sendMsg( msg.chat_id_, msg.id_, 1,"*📬 ⁞ عذرا لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مره اخره*\n", 1, "md")    
return false  end 
local GETNUM = KASPERBOT:get(KASPER_ID.."GAMES"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
KASPERBOT:del(KASPER_ID.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
KASPER_sendMsg( msg.chat_id_, msg.id_, 1,'* ⁞🚦 ⁞ مبروك فزت وطلعت المحيبس بل ايد رقم { '..NUM..' }\n🎊 ⁞ لقد حصلت على { 3 }من نقاط يمكنك استبدالهن برسائل *', 1, "md")    
KASPERBOT:incrby(KASPER_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,3)  
...
if KASPERBOT:get(KASPER_ID.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
KASPER_sendMsg( msg.chat_id_, msg.id_, 1,"*📬 ⁞ عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 } *\n", 1, "md")    
return false  end 
local GETNUM = KASPERBOT:get(KASPER_ID.."GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
KASPERBOT:del(KASPER_ID..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)
KASPERBOT:del(KASPER_ID.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
KASPERBOT:incrby(KASPER_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,5)  
KASPER_sendMsg( msg.chat_id_, msg.id_, 1,'*🔖 ⁞ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸 ⁞ تم اضافة { 5 } من النقاط *\n', 1, "md")    
elseif tonumber(NUM) ~= tonumber(GETNUM) then
KASPERBOT:incrby(KASPER_ID..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(KASPERBOT:get(KASPER_ID..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)) >= 3 then
KASPERBOT:del(KASPER_ID..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)
KASPERBOT:del(KASPER_ID.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
if chat_type == 'super' then 
if not KASPERBOT:get(KASPER_ID.."LOCK:GAMES"..msg.chat_id_) then 
if MSG_TEXT[1] == 'محيبس' or MSG_TEXT[1] == 'بات' then   
Num = math.random(1,6)
KASPERBOT:set(KASPER_ID.."GAMES"..msg.chat_id_,Num) 
TEST = [[
*➀       ➁     ➂      ➃      ➄     ➅
↓      ↓     ↓      ↓     ↓     ↓
👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊
...
KASPERBOT:setex(KASPER_ID.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end

if MSG_TEXT[1] == 'خمن' or MSG_TEXT[1] == 'تخمين' then   
Num = math.random(1,20)
KASPERBOT:set(KASPER_ID.."GAMES:NUM"..msg.chat_id_,Num) 
TEST = '*\n ⁞🚦 ⁞ اهلا بك عزيزي في لعبة التخمين :\nٴ━━━━━━━━━━\n'..'⚠ ⁞ ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n\n'..'🔖 ⁞ سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ \n🎊 ⁞ الفائز سيحصل على { 5 } من النقود \n💥*'
KASPER_sendMsg( msg.chat_id_, msg.id_, 1, TEST, 1, "md") 
KASPERBOT:setex(KASPER_ID.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
if MSG_TEXT[1] == 'اسئله' or MSG_TEXT[1] == 'ختيارات' or MSG_TEXT[1] == 'بدء الاسئله' then   
KASPERBOT:set(KASPER_ID.."GAME:S"..msg.chat_id_,true) 
t1 = [[
...
KASPERBOT:set(KASPER_ID.."GAME:CHER"..msg.chat_id_,'النيل') 
elseif SENDTEXT:find('14') then
KASPERBOT:set(KASPER_ID.."GAME:CHER"..msg.chat_id_,'14') 
elseif SENDTEXT:find('الفم') then
KASPERBOT:set(KASPER_ID.."GAME:CHER"..msg.chat_id_,'الفم') 
elseif SENDTEXT:find('11') then
KASPERBOT:set(KASPER_ID.."GAME:CHER"..msg.chat_id_,'11') 
elseif SENDTEXT:find('30') then
KASPERBOT:set(KASPER_ID.."GAME:CHER"..msg.chat_id_,'30') 
elseif SENDTEXT:find('بوتين') then
KASPERBOT:set(KASPER_ID.."GAME:CHER"..msg.chat_id_,'بوتين') 
elseif SENDTEXT:find('ستيف جوبر') then
KASPERBOT:set(KASPER_ID.."GAME:CHER"..msg.chat_id_,'ستيف جوبر') 
elseif SENDTEXT:find('باريس') then
KASPERBOT:set(KASPER_ID.."GAME:CHER"..msg.chat_id_,'باريس') 
elseif SENDTEXT:find('10') then
KASPERBOT:set(KASPER_ID.."GAME:CHER"..msg.chat_id_,'10') 
elseif SENDTEXT:find('النمل') then
KASPERBOT:set(KASPER_ID.."GAME:CHER"..msg.chat_id_,'النمل') 
elseif SENDTEXT:find('حرف الواو') then
KASPERBOT:set(KASPER_ID.."GAME:CHER"..msg.chat_id_,'حرف الواو') 
elseif SENDTEXT:find('الشعر') then
KASPERBOT:set(KASPER_ID.."GAME:CHER"..msg.chat_id_,'الشعر') 
elseif SENDTEXT:find('ابراهيم') then
KASPERBOT:set(KASPER_ID.."GAME:CHER"..msg.chat_id_,'ابراهيم') 
elseif SENDTEXT:find('سحاب') then
KASPERBOT:set(KASPER_ID.."GAME:CHER"..msg.chat_id_,'سحاب') 
elseif SENDTEXT:find('الاسم') then
KASPERBOT:set(KASPER_ID.."GAME:CHER"..msg.chat_id_,'الاسم') 
elseif SENDTEXT:find('ذهب') then
KASPERBOT:set(KASPER_ID.."GAME:CHER"..msg.chat_id_,'ذهب') 
elseif SENDTEXT:find('حرف الام') then
KASPERBOT:set(KASPER_ID.."GAME:CHER"..msg.chat_id_,'حرف الام') 
elseif SENDTEXT:find('العزائم') then
KASPERBOT:set(KASPER_ID.."GAME:CHER"..msg.chat_id_,'العزائم') 
elseif SENDTEXT:find('انسات') then
KASPERBOT:set(KASPER_ID.."GAME:CHER"..msg.chat_id_,'انسات') 
elseif SENDTEXT:find('المنجنيق') then
KASPERBOT:set(KASPER_ID.."GAME:CHER"..msg.chat_id_,'المنجنيق') 
elseif SENDTEXT:find('اسيا') then
KASPERBOT:set(KASPER_ID.."GAME:CHER"..msg.chat_id_,'اسيا') 
elseif SENDTEXT:find('الاسد') then
KASPERBOT:set(KASPER_ID.."GAME:CHER"..msg.chat_id_,'الاسد') 
elseif SENDTEXT:find('6') then
KASPERBOT:set(KASPER_ID.."GAME:CHER"..msg.chat_id_,'6') 
elseif SENDTEXT:find('مهر') then
KASPERBOT:set(KASPER_ID.."GAME:CHER"..msg.chat_id_,'مهر') 
elseif SENDTEXT:find('الدلفين') then
KASPERBOT:set(KASPER_ID.."GAME:CHER"..msg.chat_id_,'الدلفين') 
elseif SENDTEXT:find('اوروبا') then
KASPERBOT:set(KASPER_ID.."GAME:CHER"..msg.chat_id_,'اوروبا') 
elseif SENDTEXT:find('الزئبق') then
KASPERBOT:set(KASPER_ID.."GAME:CHER"..msg.chat_id_,'الزئبق') 
elseif SENDTEXT:find('لندن') then
KASPERBOT:set(KASPER_ID.."GAME:CHER"..msg.chat_id_,'لندن') 
elseif SENDTEXT:find('الانسان') then
KASPERBOT:set(KASPER_ID.."GAME:CHER"..msg.chat_id_,'الانسان') 
elseif SENDTEXT:find('طوكيو') then
KASPERBOT:set(KASPER_ID.."GAME:CHER"..msg.chat_id_,'طوكيو') 
elseif SENDTEXT:find('خديجه') then
KASPERBOT:set(KASPER_ID.."GAME:CHER"..msg.chat_id_,'خديجه') 
end
KASPER_sendMsg(msg.chat_id_, msg.id_, 1,SENDTEXT, 1, 'md')
return false  
end
...
KASPERBOT:set(KASPER_ID..':Set_alii:'..msg.chat_id_,name)
...
name = katu[math.random(#katu)]
KASPERBOT:set(KASPER_ID..':Set_Amthlh:'..msg.chat_id_,name)
...
name = katu[math.random(#katu)]
KASPERBOT:set(KASPER_ID..':Set_Hzorh:'..msg.chat_id_,name)
...
if MSG_TEXT[1] == 'الاسرع' and not KASPERBOT:get(KASPER_ID.."LOCK:GAMES"..msg.chat_id_) then 
KASPERBOT:del(KASPER_ID..'SMALE:GAMES'..msg.chat_id_)
katu = {'🍏','🍎','843578','9755','25677','578866','14589','🍐','🍊','🍋','🍌','🍉','🍇','🍓','🍈','🍒','🍑','🍍','🥥','🥝','🍅','🍆','🥑','🥦','🥒','🌶','🌽','🥕','🥔','🍠','🥐','🍞','🥖','🥨','🧀','🥚','🍳','🥞','🥓','🥩','🍗','🍖','🌭','🍔','🍟','🍕','🥪','🥙','🍼','☕️','🍵','🥤','🍶','🍺','🍻','🏀','⚽️','🏈','⚾️','🎾','🏐','🏉','🎱','🏓','🏸','🥅','🎰','🎮','🎳','🎯','🎲','🎻','🎸','🎺','🥁','🎹','🎼','🎧','🎤','🎬','🎨','🎭','🎪','🎟','🎫','🎗','🏵','🎖','🏆','🥌','🛷','🚕','7643','93289','3457','95439','378865','24568','9976','289','2288','2854','🚗','🚙','🚌','🚎','🏎','🚓','🚑','🚚','🚛','🚜','🇮🇶','⚔','🛡','🔮','🌡','💣','📌','📍','📓','📗','📂','📅','📪','📫','📬','📭','⏰','📺','🎚','☎️','📡'}
KASPERBOT:set(KASPER_ID..'SMALE:GAME'..msg.chat_id_,katu[math.random(#katu)])
KASPER_sendMsg(msg.chat_id_, msg.id_, 1,'اسرع واحد يدز هذهہٓ ››  `'..KASPERBOT:get(KASPER_ID..'SMALE:GAME'..msg.chat_id_)..'`', 1, 'md')
end

if MSG_TEXT[1] == 'معاني' and not KASPERBOT:get(KASPER_ID.."LOCK:GAMES"..msg.chat_id_) then 
KASPERBOT:del(KASPER_ID..'RTEP:CHER'..msg.chat_id_)
...
name = katu[math.random(#katu)]
KASPERBOT:set(KASPER_ID..'CHEK:CHER'..msg.chat_id_,name)
...
KASPER_sendMsg(msg.chat_id_, msg.id_, 1,'اسرع واحد يدز معنى السمايل يفوز » { '..name..' }', 1, 'md')
end

if MSG_TEXT[1] == 'ترتيب' and not KASPERBOT:get(KASPER_ID.."LOCK:GAMES"..msg.chat_id_) then 
KASPERBOT:del(KASPER_ID..'CHER:GAME'..msg.chat_id_)
...
name = katu[math.random(#katu)]
KASPERBOT:set(KASPER_ID..'klmo'..msg.chat_id_,name)
...
KASPER_sendMsg(msg.chat_id_, msg.id_, 1,'*💥 ⁞ اسرع واحد يرتب هاي الكلمه » {'..name..'} يفوز 🎉*\n', 1, 'md')
end

if MSG_TEXT[1] =='نقودي' then 
if tonumber((KASPERBOT:get(KASPER_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_) or 0)) == 0 then
KASPER_sendMsg(msg.chat_id_, msg.id_, 1, ' *💬 ⁞ ليس لديك نقود ،\n📬 ⁞ للحصول ؏ النقود ،\n ⁞🚦 ⁞ ارسل الالعاب وابدأ اللعب ! *', 1, 'md') 
else
NUMPGAME = (KASPERBOT:get(KASPER_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_))
KASPER_sendMsg(msg.chat_id_, msg.id_, 1,'* ⁞🚦 ⁞ عدد النقود التي ربحتها هي » { '..NUMPGAME..' }\n📬 ⁞ تسطيع بيع نقودك ولحصول على (50) رساله مقابل كل نقطه من النقود *\n', 1, 'md') 
end
end
...
return false end
if tonumber(KASPERBOT:get(KASPER_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)) == 0 then
KASPER_sendMsg(msg.chat_id_, msg.id_, 1,'\n* ⁞🚦 ⁞ ليس لديك نقود من الالعاب \n📬 ⁞ اذا كنت تريد ربح النقود \n🎮 ⁞ ارسل الالعاب وابدأ اللعب ! *', 1, 'md') 
else
local NUM_GAMES = KASPERBOT:get(KASPER_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)
if tonumber(NUMPY) > tonumber(NUM_GAMES) then
KASPER_sendMsg(msg.chat_id_, msg.id_, 1,'\n* ⁞🚦 ⁞ ليس لديك نقود بهاذا العدد \n📬 ⁞ لزيادة نقودك في اللعبه \n🎮 ⁞ ارسل الالعاب وابدأ اللعب ! *', 1, 'md') 
return false end
local NUMNKO = (NUMPY * 50)
KASPERBOT:decrby(KASPER_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,NUMPY)  
KASPERBOT:incrby(KASPER_ID..'user:messages:'..msg.chat_id_..':'..msg.sender_user_id_,NUMNKO)  
...
return false  end 
if KASPERBOT:get(KASPER_ID..'LOCK:GAMES'..msg.chat_id_) then
taha = '* ⁞🚦 ⁞ تم تفعيل الالعاب في المجموعه *\n✓' 
KASPER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
KASPERBOT:del(KASPER_ID..'LOCK:GAMES'..msg.chat_id_) 
else
...
KASPER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
KASPERBOT:set(KASPER_ID..'LOCK:GAMES'..msg.chat_id_,true) 
else
...
KASPERBOT:set(KASPER_ID..'SET:ID:USER'..msg.chat_id_,ID_USER)  
KASPERBOT:setex(KASPER_ID.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_,500,true)  
KASPER_sendMsg(msg.chat_id_, msg.id_, 1,'*📊 ⁞ ارسل لي عدد الرسائل الذي تريده*\n', 1, 'md') 
end
...
return false  end 
local ID_USER = MSG_TEXT[2]
KASPERBOT:set(KASPER_ID..'SET:ID:USER:NUM'..msg.chat_id_,ID_USER)  
KASPERBOT:setex(KASPER_ID.."SETEX:NUM"..msg.chat_id_..""..msg.sender_user_id_,500,true)  
KASPER_sendMsg(msg.chat_id_, msg.id_, 1,'*📊 ⁞ ارسل لي عدد النقاط الذي تريده*\n', 1, 'md') 
end
...
KASPER_sendMsg(msg.chat_id_, msg.id_, 1,COMGAME, 1, 'md') 
end
end
