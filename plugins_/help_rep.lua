...
if not KASPERBOT:get(KASPER_ID..'lock:reoly:bot'..msg.chat_id_) then
...
if KASPERBOT:get(KASPER_ID..'lock:reoly:bot'..msg.chat_id_) then
taha = '*🚦  ⁞ تم تفعيل ردود البوت *\n✓' 
KASPER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
KASPERBOT:del(KASPER_ID..'lock:reoly:bot'..msg.chat_id_) 
else
...
KASPER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
KASPERBOT:set(KASPER_ID..'lock:reoly:bot'..msg.chat_id_,true) 
else
