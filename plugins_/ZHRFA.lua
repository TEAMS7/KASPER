...
if KASPERBOT:get(KASPER_ID.."skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then   
if text and text:match("^الغاء$") then 
KASPER_sendMsg(msg.chat_id_, msg.id_, 1, "*💥¦* تم الغاء امر الزخرفه ✔", 1, "md")
KASPERBOT:del(KASPER_ID.."skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_)     
return false
end
if text then
if utf8.len(text) > 20 then
KASPER_sendMsg(msg.chat_id_, msg.id_, 1,'*🚦¦ لا يمكن زخرفة اكثر من 20 حرف *', 1, 'md') 
KASPERBOT:del(KASPER_ID.."skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_)     
return false
end
...
KASPER_sendMsg(msg.chat_id_, msg.id_, 1, SEND_SKRF,  1, "md")
KASPERBOT:del(KASPER_ID.."skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_)     
end
end
end
...
if KASPERBOT:get(KASPER_ID..'lock:skrfa'..msg.chat_id_)  then
taha = '*🚦¦ تم تفعيل الزخرفه *\n✓' 
KASPER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
KASPERBOT:del(KASPER_ID..'lock:skrfa'..msg.chat_id_) 
else
...
if not KASPERBOT:get(KASPER_ID..'lock:skrfa'..msg.chat_id_)  then
taha = '*🚦¦ تم تعطيل الزخرفه *\n✓' 
KASPER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
KASPERBOT:set(KASPER_ID..'lock:skrfa'..msg.chat_id_,true) 
else
...
if not KASPERBOT:get(KASPER_ID.."lock:skrfa"..msg.chat_id_) then   
KASPERBOT:setex(KASPER_ID.."skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)   
local t = '*⚡¦* ارسل الاسم الذي تريد زخرفته \n*📬¦* سواء كان بالعربي او بالانكلش 🍁'   
KASPER_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md') 
else
KASPER_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ الزخرفه معطله *', 1, 'md') 
end
return false
end
